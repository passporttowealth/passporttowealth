...
5. **Authenticate the AI assistant** (§4.3) — the only third-party touchpoint required at install time. The publishing-host signup that used to live here has moved to `publish.sh` and runs on first share (see §4.4) — most installs never trigger it.
6. **Finalize:**
...
7. **Verify** end-to-end with the diagnostic (§4.5) and report green.
8. **Done message:** "✓ Your workspace is ready. Double-click START-HERE on your Desktop whenever you want to use it."
